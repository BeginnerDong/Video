<template>
	<view>
		...
		<view class="card m-3 py-4 px-3 line-h colorf d-flex flex-column a-end">
			...
			<view class="font-60 font-w py-5 w-100">00.00</view>
		...
		<view class="flex flex-wrap px-3">
			...
			v-for="(item,index) in 3" :key="index" @click="chooes(index)">
				<view class="font-30 font-w">月卡</view>
				<view class="font-30 font-w">100元</view>
				<view class="h100">
					<image src="../../static/images/thebalanceof-icon2.png" class="wh40 mt-4" v-show="chooesIndex==index"></image>
				</view>
				<view class="font-22 color8">送6个灯泡</view>
			</view>
		</view>
